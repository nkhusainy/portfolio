...
\usepackage{subcaption} % For organizing the plots from R into 1 figure

\title{Exercise 1 MLARPIS}
...
Back in our second semester, I remember in Bayesian Statistics course we were told to memorize the equation of normal distribution probability density function. We all tried to, in preparation for the exam. One semester later, I manage to completely forget it already, so I will add the equation as a reminder here.
\begin{equation}
